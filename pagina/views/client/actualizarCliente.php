...
<div class="container mt-5">
    <form action="cliente.php" method = "POST">
        ...
        <input type="text" class="form-control mb-3" name="nombre" value="<?php echo $row['nombresClientes'] ?>">
        <input type="text" class="form-control mb-3" name="apellido" value="<?php echo $row['apellidosClientes'] ?>">
